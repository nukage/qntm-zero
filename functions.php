...
function powder_zero_enqueue_stylesheet_script()
{
	...
	wp_enqueue_style('tailwind-app', get_template_directory_uri() . '/css/app.css', array(), wp_get_theme()->get('Version'));
}
 ...
 * Requires
 */
require_once 'resources/qntm-functions.php'; // QNTM's custom functions